...
<footer id="main-footer">
    ...
    <nav>
        <ul id="social-links">
            <li><a href="https://steelintime.co.uk/store/#/contact"><i class="fa fa-envelope"></i></a></li>
    ...
    <p id="footer-line">{{ config('steelintime.footerline') }}</p>
    <p id="copyright-line">{{ config('steelintime.copyright') }}</p>
