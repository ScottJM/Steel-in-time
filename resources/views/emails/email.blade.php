...
<head>
    ...
    <style type="text/css">
        ...
        * { font-family: "Roboto", "Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif; }
        ...
        h1,h2,h3,h4,h5,h6 {
            font-family: "Roboto", "HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif; line-height: 1.1; margin-bottom:15px; color:#000;
        }
            ...
            <div class="content">
                <table bgcolor="#2c3e50">
                    <tr>
                        ...
                        <td align="right"><h5 class="collapse" style="color:#ffffff">Steel In Time</h5></td>
                    </tr>
                </table>
            </div>
